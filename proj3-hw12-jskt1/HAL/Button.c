...
void initButtons() {
    ...
    // enable the port 4 interrupt related to JSB (enabling bit)
    ...
    // enable the port 5 interrupt related to BB1 (enabling bit)
    ...
    // enable the port 3 interrupt related to BB1 (enabling bit)
    ...
    // enable the port 3 interrupt related to LB1 (enabling bit)
    ...
    // enable the port 3 interrupt related to LB2 (enabling bit)
    Interrupt_enableInterrupt(INT_PORT1);
...
void PORT1_IRQHandler() {
    ...
    // We check to see if the port4 interrupt came from LB1 or LB2
